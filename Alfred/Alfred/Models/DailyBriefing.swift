...
//  Alfred
//
//  What the Home tab says. The greeting rotates on a few-hour rhythm so it never goes stale
//  mid-afternoon, and the briefing turns the phone's calendar into a sentence or two of plain
//  English — meetings, work due today, and exams coming up this week.
//
//  Both stay outside the view so the classification and the rotation are pure, and testable.
//
