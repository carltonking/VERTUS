...
//  Alfred Companion
//
//  Ported from the iOS app (Alfred/Alfred/Models/Message.swift) for the
//  macOS companion app. Kept byte-for-byte identical so Session 3 can drop in
//  the iOS feature views without renaming anything.
//
