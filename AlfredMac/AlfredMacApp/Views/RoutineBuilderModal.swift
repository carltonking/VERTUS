...
//  Ported from the iOS app (Alfred/Alfred/Views/RoutineBuilderModal.swift).
//
...
struct RoutineBuilderModal: View {
    ...
    /// macOS has no EditMode; a plain flag drives the Reorder/Done toggle, and
    /// drag-reorder works natively on a macOS List via .onMove.
