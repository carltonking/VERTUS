...
import { APP_NAME, BRAND_TITLE, BRAND_VERSION, ENV_SESSION_DIR, expandTildePath, getAgentDir, getPackageDir, VERSION } from "./config.ts";
...
export async function main(args: string[], options?: MainOptions) {
	...
	if (parsed.version) {
		console.log(`${BRAND_TITLE} v${BRAND_VERSION}`);
		process.exit(0);
	}
