...
//  out: Accept & Send, or Save as Draft. A free-text revise field re-runs the
//  draft through Hermes with the instruction, in place.
//  Ported from the iOS app (Alfred/Alfred/Views/Mail/DraftReviewView.swift).
//
