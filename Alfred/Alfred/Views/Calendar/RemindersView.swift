...
//  same editor as tapping a row. Reads and writes the phone's own reminders through EventKit.
//
...
private struct PermissionPrompt: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            Text("Alfred reads and manages your reminders from this phone — everything the Reminders app already holds. Nothing leaves the device.")
                .font(.system(size: 16))
