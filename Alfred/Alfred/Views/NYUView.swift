...
//      in progress / not started). Marking submitted on the phone cancels the
//      Mac's pending deadline reminders for it.
...
//
// Everything comes from the Mac over the socket (`nyu.*`); the phone never
