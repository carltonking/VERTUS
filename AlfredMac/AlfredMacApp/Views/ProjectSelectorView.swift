...
//       resolves (the companion never knows the Mac's home directory).
...
//
//  Ported from Alfred/Alfred/Views/ProjectSelectorView.swift — identical,
//  minus the iOS-only text-input modifiers.
//
