...
//  AlfredMacApp
//
//  Ported from the iOS app (Alfred/Alfred/Views/MessageBubble.swift).
//
...
struct MessageBubble: View {
    ...
    private var avatar: some View {
        ZStack {
            ...
            TriangleShape()
                .stroke(palette.accentSoft, style: StrokeStyle(lineWidth: 1.4, lineJoin: .round))
                .padding(6)
        }
...
/// The triangle that forms Alfred's mark, used inside his avatar bubble.
