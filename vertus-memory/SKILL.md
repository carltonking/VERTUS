---
name: vertus-memory
description: Long-term memory read/write rules for VERTUS — use at session start and whenever a durable fact is learned
---

# VERTUS Memory

You have persistent memory at `~/.vertus/memory/`:
