...
//  Alfred
//
//  The iOS half of the career-ops contract. These mirror the macOS Codable
//  shapes in AlfredMac/Alfred/Career/CareerOpsManager.swift and the wire
//  dictionaries in BriefingSocketServer's career section exactly — the phone
//  decodes `career.*` results with these, and encodes `career.set_preferences`
//  back with them. Keep the two in lockstep.
//
