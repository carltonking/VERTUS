...
Exposes the same API the ALFRED server expects:
...
ALFRED_ROOT = SERVER_DIR.parents[1]
BRIDGE = ALFRED_ROOT / "alfred" / "server" / "pi_bridge.mjs"
BUN = os.environ.get("ALFRED_BUN", "bun")
