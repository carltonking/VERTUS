...
//
//  Ported from Alfred/Alfred/Views/CodeSessionView.swift — copy goes to the
//  NSPasteboard instead of UIPasteboard; everything else is identical.
//
//  Safety by construction: nothing here executes generated code. The agent
//  works on the Mac; the companion only watches, copies, and asks the Mac to
//  run its own test/commit commands.
//
